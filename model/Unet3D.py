...
class Basic3DUNet(nn.Module):
    ...
    Inputs:
        ...
        :param is_segmentation (bool): if True (semantic segmentation problem) Sigmoid/Softmax normalization is appliedafter the final convolution;
