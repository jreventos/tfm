...
class BalancedPatchGenerator(Dataset):
    def __init__(self, images_path, masks_path, patch_shape, positive_prob = 0.7, shuffle_images = False):
    ...
    @staticmethod
    def get_indexes(self, tensor, value, patch_size, num_attempts=40):
        i = 0
